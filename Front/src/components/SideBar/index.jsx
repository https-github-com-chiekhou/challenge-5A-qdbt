...
const SideBar = () => {
    return (
        <>
            ...
            <aside className="w-72 border-r border-gray-300 bg-white py-8 sidebar">
                <nav className="flex flex-col space-y-2 px-4">
                    ...
                    <a href="{{ path('app_dashboard') }}"
                        ...
                        <span className="text-sm sidebar-label">Dashboard</span>
                    </a>
                    ...
                    <a href="{{ path('app_admin_support_index') }}"
                        ...
                        <span className="text-sm sidebar-label">Messages</span>
                    </a>
                    {/* {% endif %}
                    {% if is_granted('ROLE_DOCTOR') %} */}
                    <a href="{{ path('app_doctor_service_index') }}"
                        ...
                        <span className="text-sm sidebar-label">Services</span>
                    </a>
                    <a href="{{ path('app_doctor_settings') }}"
                        className="flex items-center gap-1 rounded-md border border-gray-300 {% if app.request.get('_route') starts with 'app_doctor_settings' %} bg-indigo-600 text-white border-indigo-600 {% endif %}">
                        <span className="flex h-10 w-10 items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                        ...
                        <span className="text-sm sidebar-label">Paramètres</span>
                    </a>
                    {/* {% endif %} */}
                    <a href="{{ path('app_profile') }}"
                        className="flex items-center gap-1 rounded-md border border-gray-300 {% if app.request.get('_route') starts with 'app_profile' %} bg-indigo-600 text-white border-indigo-600 {% endif %}">
                        <span className="flex h-10 w-10 items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                        ...
                        <span className="text-sm sidebar-label">Profil</span>
                    </a>
                    <a href="{{ path('app_appointment_index') }}"
                        className="flex items-center gap-1 rounded-md border border-gray-300 {% if app.request.get('_route') starts with 'app_appointment' %} bg-indigo-600 text-white border-indigo-600 {% endif %}">
                        <span className="flex h-10 w-10 items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                            </svg>
                        </span>
                        <span className="text-sm sidebar-label">Rendez-vous</span>
                    </a>
