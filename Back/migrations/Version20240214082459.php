 ...
 */
final class Version20240214082459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE feed_back (id INT NOT NULL, client_id INT NOT NULL, prestataire_id INT NOT NULL, note INT NOT NULL, commentaire VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
